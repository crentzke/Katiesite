		...
		$.extend(this, {
			...
			buildImage: function(image) {
				if (this.$imageContainer) {
                    ...
                    // Setup image
					this.$imageContainer
						.append('<span class="image-wrapper"><a class="advance-link" rel="history" ></a></span>')
						.find('a')
						.append(image)
						.click(function(e) {
							clickHandler(e, gallery, this);
			...
			buildPager: function(pager) {
				...
				if (this.currentPage > 0) {
					...
					pager.append('<a rel="history" href="#'+this.data[prevPage].hash+'">'+this.settings.prevPageLinkText+'</a>');
				}
				...
				for (i=this.currentPage-3; i<=this.currentPage+3; i++) {
					...
					if (i == this.currentPage)
						...
						pager.append('<a rel="history" href="#'+this.data[imageIndex].hash+'">'+pageNum+'</a>');
					}
				}
		...
		if (this.settings.controlsContainerSel) {
			...
			if (this.settings.renderSSControls) {
				if (this.settings.autoStart) {
					this.$controlsContainer
						.append('<div class="ss-controls"><a href="#pause" class="pause" title="">'+this.settings.pauseLinkText+'</a></div>');
				} else {
					this.$controlsContainer
						.append('<div class="ss-controls"><a href="#play" class="play" title="">'+this.settings.playLinkText+'</a></div>');
				}
			...
			if (this.settings.renderNavControls) {
				var $navControls = this.$controlsContainer
					.append('<div class="nav-controls"><a class="prev" rel="history" title="">'+this.settings.prevLinkText+'</a> <span id="caption_information"><img src="images/webfixtures/webfixtures_infobutton.jpg"></span><a class="next" rel="history" title="">'+this.settings.nextLinkText+'</a></div>')
